...
<body>
    ...
    <script>
            ...
            function showAeroports(){
                var elemnt = document.getElementById("Idvilnec");
                var Idvilnec = elemnt.getElementsByTagName("span")[1];
                trans(Idvilnec.innerText,'Aeroports');
            ...
            function showRestaurantss(){
                ...
                var elemnt = document.getElementById("Idvilnec");
                var Idvilnec = elemnt.getElementsByTagName("span")[1];
                trans(Idvilnec.innerText,'Restaurant');
               // goTopButton.style.display = 'block';
            }
            ...
            function showHotels(){
                var elemnt = document.getElementById("Idvilnec");
                var Idvilnec = elemnt.getElementsByTagName("span")[1];
                trans(Idvilnec.innerText,'Hotel');
                // use php to get list
            ...
            alert("la ville que vous avez selectionnee a ete supprimee" + y);
            location.reload();
            }
            function trans(Idvilnec,Typenec){
                // Créer un objet XMLHttpRequest
                fetch('affiche ville.php', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/x-www-form-urlencoded',
                    },
                    body: 'Idvilnec=' + encodeURIComponent(Idvilnec) + '&Typenec=' + encodeURIComponent(Typenec)
                    });
                }
        </script>
</body>
