            ...
            <form id="Recherche-info" method="POST" enctype = "multipart/form-data" action="API.php">
                <div id="main-info">
                    <div class="contain">
                        ...
                        <input type="text" id="Continent" name="Continent" maxlength="10" list="continent" pattern="[A-Za-zÀ-ÿ\s]+" title="ne peut pas avoir des numbre !!" value = '<?php  getData('nomcon'); ?>' onchange="Cascadepays();" required>
