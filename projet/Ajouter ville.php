    ...
    <div id="Bodyleft" >
        ...
        <section>    
            ...
            <form id="Recherche-info" method="POST" enctype = "multipart/form-data" action="API.php">
                <div id="main-info">
                    ...
                    <div class="contain">
                        <label for="Ville">Ville</label>  <input type="text" id="Ville" name="Ville2" pattern="[A-Za-zÀ-ÿ\s]+" maxlength="10" list="ville" value='<?php getData('nomvil'); ?>' required>
                    </div>
        ...
        <dialog id="DialogAddPays" >
            <form method="POST" action="API.php">
                <h2>Ajouter Pays</h2>
                    <div class="contain">
                    <label for="ContinentPays">Continent  </label><input type="text" name="ContinentPays" maxlength="10" list="continent"  pattern="[A-Za-zÀ-ÿ\s]+" required>
                        <datalist id='continent'>
                            <?php listeselect($_SESSION['contient'],'Nomcon');?>
                        </dataliste>
                    </div>
                        ...
                        <div class="contain">
                            <label for="addPays">Pays  </label> <input type="text"  name="addPays" maxlength="10" pattern="[A-Za-zÀ-ÿ\s]+" required>
                        </div>
